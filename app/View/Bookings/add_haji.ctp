<div class="row-fluid">
    <div class="span3">
		<h3 class="heading">Tambah Transaksi Haji Baru</h3>
		<?php echo $this->Form->create('Booking', array('class' => 'form_validation_ttip'));?>
			<div class="formSep">
				...
				<div class="row-fluid">
					<div class="span12">
						<label>Porsi Haji <span class="f_req">*</span></label>
						<?php echo $this->Form->text('porsi_haji', array('class' => 'required number', 'minlength' => '2')); ?>
					</div>
				</div>
				<div class="row-fluid">
						<div class="span12">
...
<div class="span5">
		<h3 class="heading">Persyaratan Haji</h3>
...
<div class="span4">
		<h3 class="heading">Perlengkapan Haji</h3>
		<table class="table table-bordered table-striped table_vam">
            <thead>
                <tr>
                	<th>Remark</th>

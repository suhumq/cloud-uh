...
function displayTableUmrah(data){
        ...
        html += "<tr><td colspan='3'>Jumlah Pembayaran</td><td colspan='5'>Rp. "+ formatCurrency(jumlah)+ " ($."+todollar.toFixed(2)+") <br/> $.  "+ formatCurrency(jumlah2) +"</td></tr>";
        html += "<tr><td colspan='3'>Sisa Pembayaran</td><td colspan='5'>$. "+(parseFloat(price_brosure,2) - (todollar + jumlah2)).toFixed(2)+"</td></tr>"
        html +=  "</tbody></table>";
       // html +=    "</div></div></div>";
        return html;
}
